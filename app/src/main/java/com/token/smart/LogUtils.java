...
public final class LogUtils {
    ...
    public static String sGlobalTag = "数字钥匙"; // log标签
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && BaseApplication.getInstance().getExternalCacheDir() != null)
                defaultDir = BaseApplication.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = BaseApplication.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
            LogUtils.e(defaultDir);
